...
<body>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-8">
            {{ $tipoVeiculo === 'moto' ? 'Motos' : 'Carros' }} usados e seminovos em {{ $location['cidade'] ?? 'São Paulo' }} - {{ $location['estado'] ?? 'SP' }}
        </h1>
    ...
    {{ $tipoVeiculo === 'moto' ? 'bg-blue-900 text-white' : 'bg-white text-gray-700' }}" ">
                        ...
                        <div class="mb-6">
                            ...
                            <select class="input-text w-full" name="cilindrada">
                                ...
                                <option value="125" {{ request('cilindrada') == '125' ? 'selected' : '' }}>Até 125cc</option>
                                <option value="250" {{ request('cilindrada') == '250' ? 'selected' : '' }}>126-250cc</option>
                                <option value="500" {{ request('cilindrada') == '500' ? 'selected' : '' }}>251-500cc</option>
                                <option value="1000" {{ request('cilindrada') == '1000' ? 'selected' : '' }}>501-1000cc</option>
                                <option value="1001" {{ request('cilindrada') == '1001' ? 'selected' : '' }}>Acima de 1000cc</option>
                            </select>
                        </div>
                        @endif
            ...
            <main class="lg:col-span-3">
                ...
                <div class="bg-white rounded-lg shadow p-6 text-center">
                    ...
                    <a href="{{ route('search.index') }}?tipo={{ $tipoVeiculo }}" class="btn-primary inline-block mt-4">Limpar filtros</a>
                </div>
                @else
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <div class="product-card">
                        <div class="relative">
                            ...
                            <div class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-xs px-2 py-1 rounded">1/{{ $anuncio->fotos->count() ?? 1 }}</div>
                ...
                <div class="mt-10 flex justify-center items-center space-x-2">
                    ...
                    @else
                    <a href="{{ $anuncios->previousPageUrl() }}&tipo={{ $tipoVeiculo }}" class="p-2 rounded-md hover:bg-gray-200">
                        <span class="material-icons text-gray-600">chevron_left</span>
                    </a>
                    @endif
                    ...
                    @else
                    <a href="{{ $url }}&tipo={{ $tipoVeiculo }}" class="px-4 py-2 text-sm font-medium rounded-md hover:bg-gray-200 text-gray-700">{{ $page }}</a>
                    @endif
                    @endforeach

                    @if ($anuncios->hasMorePages())
                    <a href="{{ $anuncios->nextPageUrl() }}&tipo={{ $tipoVeiculo }}" class="p-2 rounded-md hover:bg-gray-200">
